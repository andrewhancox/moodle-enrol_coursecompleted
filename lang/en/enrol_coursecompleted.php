...
$string['showcontinuebutton_help'] = 'Show continue button on enrolment screen by default.';
$string['showcontinuebuttoninstance'] = 'Show continue button';
$string['showcontinuebuttoninstance_help'] = 'Show continue button on enrolment screen.';
$string['showcontinuebutton:sitedefault'] = 'Site default';
$string['showcontinuebutton:enabled'] = 'Enabled';
$string['showcontinuebutton:disabled'] = 'Disabled';
